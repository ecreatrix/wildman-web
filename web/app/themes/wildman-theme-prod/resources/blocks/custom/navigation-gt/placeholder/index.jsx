...
import { navigation, Icon } from '../@wordpress/icons/build-module/icon';
...
export default function NavigationPlaceholder( {
	...
	return (
		<>
			<Placeholder className="wa-block-navigation-placeholder">
				{
				...
				<div
					...
					className="wa-block-navigation-placeholder__controls"
				>
					<div className="wa-block-navigation-placeholder__actions">
