...
function addInspectorControls( BlockEdit ) {
	...
	return ( settings ) => {
		...
		//onsole.log('booking:' + bookingLink)
		//onsole.log({ url: setBookingLink, opensInNewTab: true, nofollow })
		...
		const linkValue = { url: setBookingLink, opensInNewTab: true, nofollow }
		...
		return (
			<>
				...
				<InspectorControls>
					<PanelBody
						title={ __( 'Booking Link Options', 'watheme-domain' ) }
						initialOpen={ true }
					>
						<div className="booking-link">
							...
							/> }
							{ false && useBookingLink && <LinkControl
								style={ { padding: '0px' } }
								value={ linkValue }
								onChange={ ( {
									url: newURL,
