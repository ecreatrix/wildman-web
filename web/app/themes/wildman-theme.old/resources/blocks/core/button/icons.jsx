...
export const ICONS = [
	{
		label: __( 'Chevron Right', 'watheme' ),
		value: 'chevron-right',
		icon: chevronRight,
	},
	{
		label: __( 'Chevron Left', 'watheme' ),
		value: 'chevron-left',
		icon: chevronLeft,
	},
	{
		label: __( 'Chevron Right (Small)', 'watheme' ),
		value: 'chevron-right-small',
		icon: chevronRightSmall,
	},
	{
		label: __( 'Chevron Left (Small)', 'watheme' ),
		value: 'chevron-left-small',
		icon: chevronLeftSmall,
	},
	{
		label: __( 'Shuffle', 'watheme' ),
		value: 'shuffle',
		icon: shuffle,
	},
	{
		label: __( 'Arrow Right', 'watheme' ),
		value: 'arrow-right',
		icon: arrowRight,
	},
	{
		label: __( 'Arrow Left', 'watheme' ),
		value: 'arrow-left',
		icon: arrowLeft,
	},
	{
		label: __( 'Next', 'watheme' ),
		value: 'next',
		icon: next,
	},
	{
		label: __( 'Previous', 'watheme' ),
		value: 'previous',
		icon: previous,
	},
	{
		label: __( 'Download', 'watheme' ),
		value: 'download',
		icon: download,
	},
	{
		label: __( 'External Arrow', 'watheme' ),
	...
	{
		label: __( 'External', 'watheme' ),
		value: 'external',
		icon: external,
	},
	{
		label: __( 'Login', 'watheme' ),
		value: 'login',
		icon: login,
	},
	{
		label: __( 'Lock', 'watheme' ),
		value: 'lock-outline',
		icon: lockOutline,
	},
	{
		label: __( 'Avatar', 'watheme' ),
		value: 'comment-author-avatar',
		icon: commentAuthorAvatar,
	},
	{
		label: __( 'Cloud', 'watheme' ),
		value: 'cloud',
		icon: cloud,
	},
	{
		label: __( 'Cloud Upload', 'watheme' ),
		value: 'cloud-upload',
		icon: cloudUpload,
	},
	{
		label: __( 'Help', 'watheme' ),
		value: 'help',
		icon: help,
	},
	{
		label: __( 'Info', 'watheme' ),
		value: 'info',
		icon: info,
	},
	{
		label: __( 'WordPress', 'watheme' ),
		value: 'wordpress',
		icon: wordpress,
	},
];
	...
	return ( settings ) => {
		...
		return (
			<>
				...
				<InspectorControls>
					<PanelBody
						title={ __( 'Icon settings', 'watheme' ) }
